<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PurchaseFromSale.aspx.vb" Inherits="Reports_PurchaseFromSale" %>
...
<body>
    ...
    <div style="width: 800px">
        ...
        <div id="divreportContent">
            ...
            <br />
            <br />
            <div id="divPurchaseFromSale" style="text-align: center;">
                The following Certificates of Purchase were awarded at the <asp:Label ID="lblClient" runat="server" /> Tax Lien Sale on <asp:Label ID="lblSaleDate" runat="server" />:
                <br />
                <br />
                <br />
                <asp:GridView ID="gvPurchaseFromSale" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Interest Rate" DataField="Interest" DataFormatString="{0:P0}" />
                        <asp:BoundField HeaderText="Treasurer Fee" DataField="FaceValueofCP" DataFormatString="{0:C}" />
                    </Columns>
